/**
 * Error Drilldown - Level 3: Conversation Details Wrapper
 * 
 * Wrapper component that adapts ConversationViewer to work with drilldown framework
 * Future: Could highlight error turns in red/warning color
 */
...
export default function Level3ConversationWrapper({
  ...
  console.log('Error Level3ConversationWrapper - context:', context, 'data:', data, 'callId:', callId);
